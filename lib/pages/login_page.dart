        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child:Form(
              ...
              const Row(
                children: [
                    Text('Login',style: TextStyle(color: Colors.white,fontSize: 25,fontFamily: 'Pacifico'),),
                ],
              ),
              const SizedBox(height: 10,),
               CustomTextField(keyboardType: TextInputType.emailAddress,labelText: 'Email',onChanged: (data){
                email=data;
               },),
              const SizedBox(height: 10,),
               ...
               }, icon: obscureText ==true? const Icon(Icons.visibility,color: Colors.white,):const Icon(Icons.visibility_off,color: Colors.white,) ),),//remove_red_eye
